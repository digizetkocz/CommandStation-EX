...
static void writeRegister(I2CAddress address, byte reg, byte value); // The I2CAddress type must be present here. The byte is not enough to initialize the servo module for more than one muxer. 
